...
const backupDir = 'D:\\live work\\UIPlatform\\backup\\codemanual';

// 2. Configuration for paths and ignores
const config = {
    ui: {
        source: 'D:\\live work\\UIPlatform\\WG-Platform',
        ignore: ['**/node_modules/**', '**/bin/**', '**/obj/**', '**/.git/**']
    },
    api: {
        source: 'D:\\live work\\IQS_Forge\\API',
        ignore: ['**/bin/**', '**/obj/**', '**/.git/**']
    }
};
...
function createBackup() {
    ...
    // Name the file based on the target (e.g., uiplatform-both-13042026.zip)
    const filePrefix = `uiplatform`;
